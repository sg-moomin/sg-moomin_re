					...
					<div class="d-flex">
						...
						<div class="author-info text p-4 p-md-5 mt-5 mb-5">
							<div class="desc">
								...
								<h1 class="mb-4">
									<span>My Name is Lumin</span>
								</h1>
								<p class="mb-4">저는 현재 대학교를 졸업 후 초보 개발자가 되기 위해 노력중입니다.
								개발분야는 웹과 데이터 분석쪽을 공부하고 있으며 더 나아가서 보안 분야까지 공부를 하고 있는 취준생입니다.
								취준생이지만 인생을 보람차게 살고 싶은 생각에 2020년도 9월부터 SNS를 시작했으며 인스타그램까지 
								매일 열심히 포스팅하는 청년입니다.</p>
								<h3 class="signature h1">Lumins</h3>
						...
						<div class="col-md-10">
							<div class="row">
								<div
									...
									<div class="block-18">
										<div class="text d-flex align-items-center">
											<strong class="number" data-number="120">0</strong> <span>Pounds
												of Equipment</span>
										</div>
									</div>
								</div>
								<div
									...
									<div class="block-18">
										<div class="text d-flex align-items-center">
											<strong class="number" data-number="150">0</strong> <span>Studio
												Session</span>
										</div>
									</div>
								</div>
								<div
									...
									<div class="block-18">
										<div class="text d-flex align-items-center">
											<strong class="number" data-number="200">0</strong> <span>Finished
												Photosessions</span>
										</div>
									</div>
								</div>
								<div
									...
									<div class="block-18">
										<div class="text d-flex align-items-center">
											<strong class="number" data-number="200">0</strong> <span>Happy
												Clients</span>
										</div>
									</div>
								</div>
				...
				<div class="container">
					...
					<div class="row no-gutters">
						<div class="col-sm-12 col-md ftco-animate">
							<a href="resources/images/image_1.jpg"
						...
						<div class="col-sm-12 col-md ftco-animate">
							<a href="resources/images/image_2.jpg"
								class="insta-img image-popup"
						...
						<div class="col-sm-12 col-md ftco-animate">
							<a href="resources/images/image_3.jpg"
								class="insta-img image-popup"
						...
						<div class="col-sm-12 col-md ftco-animate">
							<a href="resources/images/image_4.jpg"
								class="insta-img image-popup"
						...
						<div class="col-sm-12 col-md ftco-animate">
							<a href="resources/images/image_5.jpg"
								class="insta-img image-popup"
