					...
					<div class="row">
						<div class="col-lg-8 ftco-animate">
							...
							<p>Molestiae cupiditate inventore animi, maxime sapiente
								...
								eaque sequi deleniti tenetur dolore amet fugit perspiciatis
								ipsa, odit. Nesciunt dolor minima esse vero ut ea, repudiandae
								suscipit!</p>
							<h2 class="mb-3 mt-5 font-weight-bold">#2. Creative
								WordPress Themes</h2>
